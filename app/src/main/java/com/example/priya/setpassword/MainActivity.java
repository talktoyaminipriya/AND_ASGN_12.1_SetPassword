package com.example.priya.setpassword;
...
// sets password for Screenlock option
            ...
            public void onClick(View view) {
                ...
                if (cb_chechkbox.isChecked()) {
                    ...
                    Toast.makeText(MainActivity.this,
                            "Password wil be set for Screenlock option is checked", Toast.LENGTH_SHORT).show();
        ...
        tv_lockthescreen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (cb_chechkbox.isChecked()) {
                    ...
                    Toast.makeText(MainActivity.this, "Password set for Screenlock",
